...
mixin _$AppStore on AppStoreBase, Store {
  ...
  set appTextPrimaryColor(Color value) {
    _$textPrimaryColorAtom.reportWrite(value, super.appTextPrimaryColor, () {
  ...
  final _$iconEditTextBackColorAtom =
  Atom(name: 'AppStoreBase.editTextBackColor');

  @override
  Color get editTextBackColor {
    _$iconEditTextBackColorAtom.reportRead();
    return super.editTextBackColor;
  }

  @override
  set editTextBackColor(Color value) {
    _$iconEditTextBackColorAtom.reportWrite(value, super.editTextBackColor, () {
