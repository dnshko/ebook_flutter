...
class _SearchViewState extends State<SearchView> {
  ...
  int pageNumber = 1;
  int totalPages = 1;
  var mBookList = List<BookInfoDetails>();
        ...
        child: TextFormField(
           controller: searchByBook,
            ...
            onFieldSubmitted: (term) {
              ...
              getSearchHistory();
              getViewAllBookData(searchByBook.text,
                  isNewSearch: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  keyString(context, "lbl_search_result_from") +
                      " \"" +
                      mSearchText +
                      "\"",
                  style: TextStyle(
              ...
              (mBookList.isNotEmpty)
                  ? Center(child: viewMoreDataLoader.visible(mIsLoading))
